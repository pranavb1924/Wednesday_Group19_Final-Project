...
public class AddLawyerJPanel extends javax.swing.JPanel {
    ...
    public void validateFields() {
        ...
        if (!txtFirstName.getText().matches("[a-zA-Z0-9 ]+")) {
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(6, 6, 6)
                        .addComponent(btnUpdate, javax.swing.GroupLayout.PREFERRED_SIZE, 313, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addContainerGap())
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
        ...
        layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {txtEmail, txtFirstName, txtPhone});
        ...
        layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {txtEmail, txtFirstName, txtPhone});
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        // Gather input values
        String lawyerName = txtFirstName.getText();
        ...
        try {
            ...
            String lawyerInsertSql = "INSERT INTO Lawyers (LawyerID, Name, Phone, Email) VALUES (?, ?, ?, ?)";
            ...
            lawyerStmt.setString(4, email);

            
            int lawyerRowsAffected = lawyerStmt.executeUpdate();
            
            if (lawyerRowsAffected > 0) {
                JOptionPane.showMessageDialog(null, "Lawyer inserted successfully.", "Success", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        try {
            ...
            // change table
            String lawyerInsertSql = "UPDATE Lawyers SET Phone = ?, Email = ?, WHERE name = ?";
            PreparedStatement lawyerStmt = this.connection.prepareStatement(lawyerInsertSql);
            lawyerStmt.setString(1, lawyerPhone);
            lawyerStmt.setString(2, email);
            lawyerStmt.setString(3, lawyerName);

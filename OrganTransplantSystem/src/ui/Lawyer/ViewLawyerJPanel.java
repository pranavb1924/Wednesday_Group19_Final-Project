...
public class ViewLawyerJPanel extends javax.swing.JPanel {
    ...
    public ViewLawyerJPanel(JPanel userProcessContainer, LawyerDirectory LawyerDirectory, Connection connection) {
        initComponents();
    ...
    private void initComponents() {
        ...
        if (tblLawyer.getColumnModel().getColumnCount() > 0) {
            ...
            tblLawyer.getColumnModel().getColumn(4).setResizable(false);
        }
